    ...
    <section id='about' className="bg-white py-20">
      <div className="container mx-auto px-4">
        <div className="text-center">
          <h2 className="text-3xl md:text-4xl text-gray-800 font-bold font-roboto">
            Why Choose JobFit-AI?
          </h2>
          <p className="mt-4 text-center text-gray-500 max-w-2xl mx-auto">
            We leverage cutting-edge technology to give you the competitive edge you need in today's job market.
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-16 gap-8">
          {features.map((feature, index) => (
            <div 
              key={index}
              className="flex flex-col items-center text-center bg-gray-50 p-8 rounded-2xl shadow-sm border border-gray-200 hover:shadow-lg hover:-translate-y-2 transition-all duration-300 ease-in-out"
            >
              <div className="bg-blue-100 p-4 rounded-full mb-6">
                {feature.icon}
              </div>
