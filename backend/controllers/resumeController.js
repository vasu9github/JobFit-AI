...
// temporary check using mock function
import AnalysisHistory from '../models/analysisHistoryModel.js';

async function getSimulatedAIResponse(resumeText, jobDescription) {
    console.log("Bypassing external API call and simulating AI analysis...");
    ...
    return new Promise(resolve => {
        setTimeout(() => {
            const mockAnalysis = {
                ...
                "suggestions": [
                    "Your resume strongly aligns with the required technologies. Consider adding a 'Projects' section to showcase your work with React and Node.js.",
                    "To better match senior roles, highlight any experience with TypeScript or consider converting a personal project to use it.",
                    "Mentioning specific state management libraries you've used with React (like Context API or Redux) would strengthen your profile.",
                    "Great job on deploying the application! Add bullet points that quantify the achievements of your projects, such as user engagement or features implemented."
                ]
            };
...
export const analyzeResume = async (req, res) => {
    ...
    try {
        const analysisResult = await getSimulatedAIResponse(resumeText, jobDescription);
